...
List<Widget> getAllWidgets(BuildContext context) {
  return [
    Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Image.asset('assets/images/flixstar.png', height: 100, width: 100),
        SizedBox(height: 20),
        Row(
          children: [
            Text(
              ...
              textScaler: TextScaler.linear(
                  ScaleSize.textScaleFactor(context, maxTextScaleFactor: 2.5)),
            ),
            Text(
              'FlixStar ',
              style:
        ...
        SizedBox(
          width:
              context.width > 750 ? context.width * 0.3 : context.width * 0.8,
          child: Text(
    ...
    Image.asset('assets/images/ss.png',height: context.width > 750 ? context.width * 0.3 : 250,)
  ];
}
          ...
          child: Container(
            ...
            child: context.width > 750
                ? Row(
                    ...
                    children: getAllWidgets(context))
                : Column(
                    children: getAllWidgets(context),
                  ),
          ),
